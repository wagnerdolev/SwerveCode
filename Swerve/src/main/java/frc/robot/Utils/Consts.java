...
public interface Consts {
    ...
    public class SwerveValues{
        ...
        public static final double DRIVING_MOTOR_KP = 0.00675;
        public static final double DRIVING_MOTOR_KI = 0.001;
        public static final double DRIVING_MOTOR_KD = 0;
        public static final double DRIVING_MOTOR_FF = 0;

        public static final double STEERING_MOTOR_KP = 0.035;
